...
# Build a search list from roots, env, and CMAKE_PREFIX_PATH.
...
if(DEFINED CMAKE_PREFIX_PATH)
  list(APPEND _TensorRT_SEARCH_ROOTS ${CMAKE_PREFIX_PATH})
endif()
list(APPEND _TensorRT_SEARCH_ROOTS "${TensorRT_WELL_KNOWN_ROOT}")
list(REMOVE_DUPLICATES _TensorRT_SEARCH_ROOTS)

set(_TensorRT_HINTS "")
foreach(_root IN LISTS _TensorRT_SEARCH_ROOTS)
  if(_root)
    list(APPEND _TensorRT_HINTS "${_root}" "${_root}/install")
  endif()
endforeach()
list(REMOVE_DUPLICATES _TensorRT_HINTS)
